...
$query = ("INSERT into graph (ean, avg_price, max_price, min_price) select ean, round(avg(price),2) avg_price, (max(price)) max_price, (min(price)) min_price from pt_products group by ean;");
